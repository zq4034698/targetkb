...
export default function Page() {
  return <GuideArticle
    ...
    intro="A 100KB limit is common on online forms, job portals, profile uploads, and document systems. Whether you call it a photo, picture, or image, the reliable approach is to work from the exact limit instead of repeatedly guessing a JPEG quality setting."
    sections={[
